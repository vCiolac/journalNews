...
import { AppBar, CardMedia, FormControlLabel, Switch, TextField, ToggleButton, Toolbar } from '@mui/material';
        ...
        <Box sx={{ bgcolor: 'background.paper', pt: 2, pb: 2 }}>
          <Container maxWidth="sm">
            <Typography variant="body2" align="center" color="text.secondary" paragraph>
              Bem-vindo! Aqui você encontrará informações atualizadas diretamente do Instituto Brasileiro de Geografia e Estatística (IBGE). Explore artigos e análises baseados em dados confiáveis para ficar por dentro das histórias que moldam nosso mundo.
            </Typography>
            ...
            <Stack sx={{ pt: 4, alignItems: 'center', flexWrap: 'wrap', flexGrow: 1 }} direction="row" spacing={1} justifyContent="center">
